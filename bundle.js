...
var $randomcolor = __webpack_require__(5);
...
mm.iconColor = function (color) {
    $m("#list i.circle").each(function (val, key, arr) {
        $m(val).css("background-color", $randomcolor({ hue: color, luminosity: "dark" }));
    });

    $m(".header").css("background-color", $randomcolor({ hue: color, luminosity: "dark" }));

    $m("#topNavi").css("background-color", $randomcolor({ hue: color, luminosity: "dark" }));
