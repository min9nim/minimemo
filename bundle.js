...
function initMemoList(uid) {
    ...
    memoRef.once('value', function (snapshot) {
        //timelog("전체메모 조회 후");
        (0, _util2.default)(".header .title").html(app.user.nickname + "'s " + memoList.length + " memos");
        $nprogress.done();
    });
}
...
function onChildAdded(data) {
    ...
    if (diff < 1000) {
        ...
        if ((0, _util2.default)(".state").html() === "") {
            ...
            (0, _util2.default)(".header .title").html(memoList.length + " memos");
        }
    }
}
...
function setHeader() {
    if (userInfo) {
        ...
        _util2.default.html(".header .title", "minimemo");
    }
}
...
mm.searchFirstTxt = function (obj) {
    ...
    (0, _util2.default)(".header .title").html(memoList.length + " memos");
    (0, _util2.default)(".header .state").html("> <span style=\"font-style:italic;\">" + firstTxt + "</span> 's " + app.memos.length + " results");
};
...
mm.searchMemo = function () {
    ...
    _util2.default.html(".header .title", memoList.length + " memos");
    _util2.default.html(".header .state", "> <span style=\"font-style:italic;\">" + word + "</span> 's " + app.memos.length + " results");
};
